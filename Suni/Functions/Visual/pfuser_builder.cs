/*
This file is responsible for building the Suni profile.
Expect:(avatar-url, banner-name, username, money, badges)
For now the only existing banner template is night/nightwhite/nightwhitesolid.
    >*Pass the banner as {template}-{background}
*/
